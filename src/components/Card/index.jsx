...
const USER_PICTURE_IMAGE_SOURCE =
  "https://avatars.githubusercontent.com/u/168105086?v=4";
  ...
  return (
    <div className={styles.cardContainer}>
      <img
        ...
        src={BACKGROUND_IMAGE_SOURCE}
      />
      <div className={styles.cardContent}>
        <div className={styles.cardUserInfo}>
          <img
            className={styles.cardUserPicture}
            src={USER_PICTURE_IMAGE_SOURCE}
          />
          <div>
            <h4>Daniel Fablício</h4>
            <p>Há 11 minutos</p>
          </div>
        </div>

        <div className={styles.cardPostInfo}>
        ...
        <div className={styles.cardHasInfo}>
